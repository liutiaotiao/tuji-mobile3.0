<style lang="less" scoped>
  .user-list-warp{
    ...
    .user-list-pop{
      width: 687px;
      height: 710px;
      background: url('../../images/aaimg-pop/user-gongxian.png') no-repeat 0 0;
...
<template>
  <div class='user-list-warp' v-show='userListStatus'>
    <div class='user-list-pop'>
      <div class='user-list-pop_close' @click='onUserCose("userList")'></div>
      <div class='user-list-contain'>
        <div class="user_item"  v-for='(item,index) in userListArr' :key='index'>
        ...
        <div class="user_item-nodata" v-if='userListArr.length === 0'>
          暂无数据
        </div>
      </div>
    </div>
